...
### Problem
In Tauri v2, window manipulation (`minimize`, `maximize`, `close`, `start_dragging`) is gated behind strict capability permissions. The app had `decorations: false` (frameless), but [`capabilities/default.json`](file:///c:/Users/lucas/Desktop/Parzi/src-tauri/capabilities/default.json) lacked window permissions, causing all window control buttons and dragging to silently fail.

### Changes
* **Tauri Capabilities**: Updated [`src-tauri/capabilities/default.json`](file:///c:/Users/lucas/Desktop/Parzi/src-tauri/capabilities/default.json) with:
  - `core:window:default`
...
* **Native Rust Window Commands**: Added IPC commands to [`src-tauri/src/main.rs`](file:///c:/Users/lucas/Desktop/Parzi/src-tauri/src/main.rs) (`window_minimize`, `window_maximize`, `window_close`, `window_start_dragging`) to guarantee window controls bypass any frontend permission mismatches.
* **Modular Titlebar**: Created [`ui/src/lib/Titlebar.svelte`](file:///c:/Users/lucas/Desktop/Parzi/ui/src/lib/Titlebar.svelte) with working drag zone, workspace/task breadcrumb, and responsive window control buttons.
...
* **Project (Workspace)**: A repository root on disk (e.g., `strohmann`).
...
* Added [`TaskConfig`](file:///c:/Users/lucas/Desktop/Parzi/crates/parzi-core/src/lanes.rs#L166-L180) to `parzi-core`:
  ```rust
...
* Added `create_task`, `list_tasks`, `save_task`, and `delete_task` in `parzi-core` and exposed them as Tauri IPC commands in [`src-tauri/src/main.rs`](file:///c:/Users/lucas/Desktop/Parzi/src-tauri/src/main.rs) and [`ui/src/lib/api.ts`](file:///c:/Users/lucas/Desktop/Parzi/ui/src/lib/api.ts).
...
### Problem
[`ui/src/App.svelte`](file:///c:/Users/lucas/Desktop/Parzi/ui/src/App.svelte) had ballooned to 1,150 lines, containing placeholder clutter (*"Pull requests soon"*, *"Automations soon"*), duplicated cards, and hardcoded logic.

### Changes
* **Deconstructed into focused components**:
  - [`Titlebar.svelte`](file:///c:/Users/lucas/Desktop/Parzi/ui/src/lib/Titlebar.svelte): Frameless drag bar + window actions.
  - [`Sidebar.svelte`](file:///c:/Users/lucas/Desktop/Parzi/ui/src/lib/Sidebar.svelte): Project switcher, task tree with child lanes, clean footer with git branch and live runs.
  - [`TaskPlanningView.svelte`](file:///c:/Users/lucas/Desktop/Parzi/ui/src/lib/TaskPlanningView.svelte): Task objective prompt editor, plan markdown editor, and subagent lane orchestrator.
  - [`Omnibar.svelte`](file:///c:/Users/lucas/Desktop/Parzi/ui/src/lib/Omnibar.svelte): Minimalist floating glass bar.
  - [`Thread.svelte`](file:///c:/Users/lucas/Desktop/Parzi/ui/src/lib/Thread.svelte): Chronological timeline.
  - [`App.svelte`](file:///c:/Users/lucas/Desktop/Parzi/ui/src/App.svelte): Streamlined down to a clean view coordinator.
* **Eliminated Clutter**:
...
### Problem
[`ui/src/lib/Thread.svelte`](file:///c:/Users/lucas/Desktop/Parzi/ui/src/lib/Thread.svelte) previously collected all tool executions and dumped them into a flat pile at the very bottom of the conversation thread, out of order.
...
### Changes
* In [`ui/src/lib/Settings.svelte`](file:///c:/Users/lucas/Desktop/Parzi/ui/src/lib/Settings.svelte), divided the Models tab into:
